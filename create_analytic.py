...
analytic = sdk.analytics.search(name="alteiademo/pc2dtm")[0]
sdk.analytics.delete(analytic=analytic.id)

sdk.analytics.create(name="alteiademo/pc2dtm",
	version="1.0.0",
	display_name="Point Cloud (.las) to Digital Terrain Model (.tif)",
	description="Converts a Point Cloud to a Digital Terrain Model (.tif)",
